...
$data = mysqli_fetch_array(mysqli_query($connect,"select id_user,username,pass,email,nip,tbl_user.level_user,w_login,photo,user.no_lv from tbl_user,user where tbl_user.level_user=user.level_user and id_user=".$id_user));
