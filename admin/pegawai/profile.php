...
<div class="profile-user-info profile-user-info-striped">
	<div class="profile-info-row">
		...
		<div class="profile-info-value">
			<span class="editable" id="username">Anonymous</span>
		</div>
	</div>
	...
	<div class="profile-info-row">
		...
		<div class="profile-info-value">
			...
			<span class="editable" id="country">Medan</span>
			<span class="editable" id="city">Indonesia</span>
		</div>
	</div>
	...
	<div class="profile-info-row">
		...
		<div class="profile-info-value">
			<span class="editable" id="age">xx</span>
		</div>
	</div>
	...
	<div class="profile-info-row">
		...
		<div class="profile-info-value">
			<span class="editable" id="signup">2017/12/28</span>
		</div>
	</div>
	...
	<div class="profile-info-row">
		...
		<div class="profile-info-value">
			<span class="editable" id="about">Teknologi Informasi '16</span>
		</div>
	</div>
</div>
...
<div class="profile-activity clearfix">
	<div>
		<img class="pull-left" alt="Anonymous's avatar" src="assets/avatars/avatar5.png" />
...
<div class="profile-activity clearfix">
	<div>
		<img class="pull-left" alt="Anonymous2's avatar" src="assets/avatars/avatar1.png" />
		<a class="user" href="#"> Anonymous2 </a>

		is now friends with Anonymous.
		<div class="time">
			<i class="ace-icon fa fa-clock-o bigger-110"></i>
			2 hours ago
		</div>
	...
	<div class="col-xs-12 col-sm-9">
		...
		<div class="profile-user-info">
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<a href="#" target="_blank">www.Anonymous.com</a>
				</div>
			</div>
...
<div class="itemdiv memberdiv">
	<div class="inline pos-rel">
		<div class="user">
			<a href="#">
				<img src="assets/avatars/avatar5.png" alt="Anonymous's avatar" />
			</a>
		</div>
...
<div id="edit-basic" class="tab-pane in active">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="col-xs-12 col-sm-10" type="text" id="form-field-username" placeholder="Username" value="Anonymous" />
				</div>
			</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input type="email" id="form-field-email" value="Anonymous@gmail.com" />
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input type="url" id="form-field-website" value="http://www.Anonymous.com/" />
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
																	<span class="input-icon">
																		<input type="text" value="facebook_Anonymous" id="form-field-facebook" />
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
																	<span class="input-icon">
																		<input type="text" value="twitter_Anonymous" id="form-field-twitter" />
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
																	<span class="input-icon">
																		<input type="text" value="google_Anonymous" id="form-field-gplus" />
