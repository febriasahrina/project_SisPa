          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="d-block img-fluid" src="img/newsbanner1.jpg" alt="First slide">
                 <div class="carousel-caption">
                   <p class="card-text"><?php echo $splitLagi[0] ?></p>
                </div>
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="img/banner1.jpg" alt="Second slide">
                <div class="carousel-caption">
                   <p class="card-text">Sumber Berita Liputan6.com</p>
                </div>
              </div>
              <div class="carousel-item">
